...
CC			:= cc
CFLAGS		:= -Wall -Wextra -pthread -ffast-math -fno-math-errno -g -march=native -fenable-matrix
DEP_FLAGS	:= -MMD -MP
AR			:= ar rcs
RM			:= rm -rf
